...
This directory contains comprehensive documentation for all API integrations used in the Professional Pipeline Dashboard.

## 📋 Table of Contents

### GoHighLevel (GHL) Integration
- **[Calendar API](calendar-api.md)** - Calendar operations, appointments, and scheduling
- **[Appointments API](appointments-api.md)** - Appointment management and event handling  
- **[Authentication](authentication.md)** - API authentication and security
- **[Webhooks](webhooks.md)** - Real-time event handling

### Internal APIs
- **[Pipeline API](pipeline-api.md)** - Pipeline and lead management
- **[Analytics API](analytics-api.md)** - Metrics and reporting
- **[User Management](user-management.md)** - Role-based access control

### Development Resources
- **[API Client Usage](api-client-usage.md)** - How to use the shared API client
- **[Error Handling](error-handling.md)** - Proper error handling patterns
- **[Testing APIs](testing-apis.md)** - API testing strategies
- **[Rate Limiting](rate-limiting.md)** - Handling API rate limits
...
// Get free slots
const freeSlots = await ghlApiClient.calendar.getFreeSlots(calendarId, {
  startDate: '2024-01-15',
  endDate: '2024-01-22'
})

// Create appointment
const appointment = await ghlApiClient.appointments.create({
  calendarId: 'cal_123',
